...
-	Mathematics for Machine Learning – Marc Peter Deisenroth, 2019
...
-	Livro: Matemática para Ciências de Dados
...
-	Explicar o modelo que descreve a relação entre y_i e x_ij (i linha-usuário, j coluna-covariável)
